"""Feature Engineering, Class Balancing (SMOTE), Model Training & Comparison."""
...
def smote_oversample(X, y, minority_label=1, k_neighbors=5, random_state=RANDOM_STATE):
    """k-NN based SMOTE, implemented directly on scikit-learn to avoid an
    extra dependency."""
...
def main():
    ...
    joblib.dump(best_model, os.path.join(MODELS_DIR, "fraud_detection_model.joblib"), compress=3)
