"""
04_fraud_pattern_analysis.py

Fraud Pattern & Feature Importance Analysis
---------------------------------------------
Extracts feature importance from the trained model, profiles how fraudulent
transactions differ from legitimate ones, and writes a structured summary
(JSON) used to build the Business Insights Report and the presentation.
"""
